...
Denormalized feature table combining:
- measurements,
- station metadata,
- temporal attributes.

This view is intended as the primary ML-ready dataset for downstream experiments.

### vw_daily_pollution_summary
Daily aggregated pollution statistics used for:
- temporal trend analysis,
- forecasting,
- exploratory analysis.

### vw_station_pollution_summary
Station-level aggregated pollution statistics supporting:
- spatial analysis,
- hotspot detection,
